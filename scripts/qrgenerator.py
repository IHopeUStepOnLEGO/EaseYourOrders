from server import STATIC_PATH, qrgenerator
...
def return_template(__template__):
    ...
    if request.method == 'POST':
        ...
        #new_im.paste(img, (((new_im_size[0] - 2*im_size[0]))-0, (new_im_size[1] - im_size[1] - BORDER_SIZE )))
        ...
        return str(render_template(__template__, QRCodeIMGStyle="", QRCodeIMGFilename=imgpath))
    else:
